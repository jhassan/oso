      ...
      <header className="z-50 py-4 bg-white">
        ...
        >
          <div className="flex lg:flex-1">
            <img className="" src="/assets/oso-logo.png" alt="" />
          </div>
          ...
          <button
            type="button"
            className="h-12 px-6 py-2 bg-purple-600 rounded-lg justify-center items-center gap-2 inline-flex hidden md:block"
          >
